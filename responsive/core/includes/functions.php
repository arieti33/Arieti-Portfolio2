...
$highpriceditems = array(4438,4436);			
...
// Now register the taxonomy
  ...
  register_taxonomy('topics',array('project'), array(
    'hierarchical' => true,
    'labels' => $labels,
    'show_ui' => true,
...
'taxonomies' => array('project cats','post_tag'),
'labels' => array (
  'name' => 'Projects',
...
if ( !function_exists( 'responsive_js' ) ) {
	...
	function responsive_js() {
		...
		if ( !wp_script_is( 'tribe-placeholder' ) ) {
			...
			wp_enqueue_script('mosaic', $template_directory_uri . '/js/mosaic.1.0.1.js', array( 'jquery' ), true );
			
		}
		
				
		// if ( is_page( 'free-estimates', 'estimate-rep2'  ) ) {
			wp_enqueue_script('mosaic'		, $template_directory_uri . 'mosaic.1.0.1.js', array( 'jquery' ), true );
