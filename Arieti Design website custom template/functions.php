...
if( !function_exists("theme_styles") ) {  
    function theme_styles() { 
        ...
        wp_register_style( 'font', get_template_directory_uri() . '/font-awesome-4.1.0/css/font-awesome.css');
        wp_enqueue_style( 'font' );

        
                wp_register_style( 'layout', get_template_directory_uri() . '/library/layout.css', array() );
        wp_enqueue_style( 'layout' );
                
                        wp_register_style( 'normalize', get_template_directory_uri() . '/library/normalize.css', array() );
...
function we4_scripts(){


    wp_register_script( 'easing' , get_template_directory_uri() . '/js/jquery.easing.min.js',array('jquery'), null , true );
    wp_register_script( 'mixitup' , get_template_directory_uri() . '/js/jquery.mixitup.min.js',array('jquery','easing'), null , true );
        wp_enqueue_script('easing');
        wp_enqueue_script('mixitup');
    
}

add_action('wp_enqueue_scripts', 'we4_scripts', 100);
